...
"TXT_SELL_MARKET_INFO_2"     => "Wenn du deine eigenen LKW &Anhänger verkaufen möchtest gehe in deine Garage, wähle einen aus den du verkaufen möchtest und nutze die 'Auf dem Markt verkaufen' Schaltfläche.", //Button name must be the same as in TXT_SELL_AT_THE_MARKET
...
"TXT_CREATE_CONCERN_INFO_2"  => "Ein Konzern kann Tankstellen kaufen und diese befüllen, wenn der Treibstoff am günstigsten ist (Treibstoff-Preise ändern sich jede Stunde).",
"TXT_CREATE_CONCERN_INFO_3"  => "Als Konzern-Inhaber kannst du dann einen Preis festlegen, sodass die Unternehmen des Konzerns tanken können, wenn der Treibstoff teuer ist.",
"TXT_CREATE_CONCERN_INFO_4"  => "Zu guter Letzt; jede Stunde erhält der Konzern eine Konzern-Ladung. Diese Ladungen bringen dem ausführenden Unternehmen mehr Geld als eine normale Tour.",
...
"TXT_FILL_IN_A_PRICE"        => "Gebe einen Preis ein..",
"TXT_HIGHER_LVL_HIRE_EMPL"   => "Du brauchst ein höheres Level, um diese Art von Mitarbeiter einzustellen.",
"TXT_HR_MANAGER_INFO_1"      => "Er wird auf deine Mitarbeiter achten, sodass sie automatisch schlafen.",
"TXT_TECH_MANAGER_INFO_1"    => "Er wird auf deine Wartung achten, sodass LKW & Anhänger automatisch repariert werden.",

"TXT_NO_CONC_FUELST_CNTRY"   => "Kein Konzern-Treibstoff in diesem Land.",
"TXT_UPGRADE_REQUIRED"       => "Upgrade benötigt",
...
"TXT_WINNER_DAY_AWARD"       => "Der Gewinner des Tages erhält 5 Premium-Credits.",
"TXT_WINNER_WEEK_AWARD"      => "Der Gewinner der Woche erhält 25 Premium-Credits!",

"TXT_MONEY_TRANSFERRED_INFO" => "Wenn dein Unternehmen nicht genug Geld auf dem Konto hat um die Rechnungen zu bezahlen, wird die Bank dein Sparbuch schließen und das Geld auf dein Konto überweisen.",

"TXT_PROJECT_INFO_DELIVERY"  => "Dein Unternehmen muss alle angezeigten Ladungen liefern um Geld zu verdienen.",
"TXT_PROJECT_INFO_TIME"      => "Wenn du dieses Projekt annimmst musst du alle Ladungen rechtzeitig abliefern. Ansonsten kostet es dein Unternehmen Geld und Punkte.",
"TXT_PROJECT_INFO_DISTANCE"  => "Sieh die vor dem Annehmen die Disteanzen an, denn deine Mitarbeiter sollten in der Lage sein solche Touren zu fahren.",
"TXT_PROJECT_INFO_TRAILER"   => "Alle Projekt-Ladungen sollten mit einer Anhänger-Art gefahren werden.",
"TXT_PROJECT_INFO_COMP_EARN" => "Das Unternehmen, das die Tour fährt, erhält 35% mehr Geld verglichen mit einer normalen Ladung.",
"TXT_PROJECT_INFO_ACCEPTED"  => "Dein Unternehmen hat das Projekt angenommen.",
"TXT_FREIGHT_IN_TIME"        => "Diese Ladung muss transportiert werden bevor die Zeit abläuft.",
"TXT_CONCERN_OWNER_ACC_PROJ" => "Mitglieder mit ausreichenden Rechten dürfen dieses Projekt annehmen.",
"TXT_THIS_FREIGHT_COMPLETED" => "Die Ladung wurde abgeschlossen.",
"TXT_THIS_PROJ_FREIGHT_ACC"  => "Diese Projekt-Ladung wurde angenommen.",

"TXT_TRY_DELIVER_IN_TIME"    => "Versuche alle Ladungen rechtzeitig zu liefern.",
"TXT_THIS_FREIGHT_ACCEPTED"  => "Diese Ladung wurde angenommen.",
"TXT_DELIVERY_IS_LATE"       => "Die Lieferung ist verspätet! Achte nach dem Annehmen darauf schnell zuzustellen, ansonsten verliert dein Unternehmen Punkte!",
"TXT_VISIT_FAQ"              => "Besuche doch mal die folgende Seite und lerne mehr über unser Spiel, LogiTycoon.",
"TXT_THANK_PARTNERS"         => "Wir möchten uns bei den folgenden Partnern für die Erstellung einiger Bilder dies Spiels bedanken:",

"TXT_SPECIAL_ICON_NEAR_NAME" => "Spezial-Icon neben deinem Namen.",
"TXT_REFUEL_TRUCKS_AT_ONCE"  => "Tanke alle LKW gleichzeitig voll",
"TXT_TIME_FOR_ALL_ACTIONS"   => "Weniger Zeit für alle Aktionen",
"TXT_CHANGE_EMPLOYEE_NAME"   => "Ändere den Namen des Mitarbeiters.",

"TXT_PAYMENT_MADE_TO"        => "Deine Zahlung wird getätigt an:",
"TXT_BUY_WITH_CREDIT_CARD"   => "Kaufe mit Kreditkarte",

"TXT_BUY_CREDITS_AGREE_TERMS"=> "Mit dem Kauf von Credtis stimmst du unseren Nutzungsbedingungen (dies umfasst auch die Rückgaberichtlinien) und Datenschutzrichlinien zu und erklärst, dass du das Alter der Volljährigkeit deines Landes erreicht hast.",
"TXT_RECEIVE_CREDITS_AFTER"  => "Du erhälst die Credits sofort, wenn wir deine Zahlung erhalten haben.",
"TXT_THIS_ONE_TIME_PAYMENT"  => "Dies ist eine einmalige Zahlung. Wenn dir die Credits ausgehen musst du selbst neue Credits kaufen.",
"TXT_3DSECURE_NOT_SUP"       => "Kreditkarten, die das 3D-Secure Verfahren nutzen, werden NICHT unterstützt.",

"TXT_AUTO_GEN_MSG"           => "Dies ist eine automatisch generierte Nachricht.",
"TXT_FIRED_FROM_CONCERN_1"   => "Es tut uns leid dir mitteilen zu müssen, dass du aus unserem Konzern gefeuert wurdest.",
"TXT_CONCERN_ACCEPTATION"    => "Es freut uns dir mitteilen zu dürfen, dass wir deine Bewerbung für unseren Konzern angenommen haben.",
"TXT_CONCERN_REJECTION"      => "Es tut uns leid dir mitteilen zu müssen, dass wir deine Bewerbung für unseren Konzern abgelehnt haben.",

"TXT_READY_NEXT_ACTION"      => "Bereit für die nächste Aktion:",
"TXT_PRICES_ONLY_PREDICTION" => "Die gezeigten Preise sind nur eine Schätzung, mit Ausnahme der Ladungs-Preise.",
"TXT_PRICE_AT_DESTINATION"   => "Preis am Ziel",
"TXT_EXPIRED_FREIGHTS_CANC"  => "Abgelaufene Ladungen abgebrochen",
"TXT_FUEL_TANK_FULL"         => "Treibstoff-Tank voll",
"TXT_DAILY_DONATION_CANC"    => "Tägliche Spende abgebrochen",
"TXT_OUT_OF_FUEL"            => "Kein Treibstoff mehr",
"TXT_HIRED_AN_EMPLOYEE"      => "Mitarbeiter eingestellt",
"TXT_A_TRUCK_REPAIRED"       => "Ein LKW repariert",
"TXT_A_TRAILER_REPAIRED"     => "Ein Anhänger repariert",

"TXT_SEND_WITH_FREIGHT"      => "Als Frachtlieferung senden",
"TXT_CONTINUE_DRIVING"       => "Fahrt forsetzen"
  
//Oil Refinery Update
"TXT_CONCERN_OILREF_INFO_1"  => "Du kannst die Ölraffinerie auffüllen, wenn dir der regionale Rohölpreis niedrig genug ist.",
"TXT_CONCERN_OILREF_INFO_2"  => "Ölraffinerien können aufgefüllt werden, wenn der regionale Rohölpreis so niedrig wie möglich ist.",
"TXT_CONCERN_OILREF_INFO_3"  => "Du kannst die Ölraffinerie upgraden um ihre Produktion zu erhöhen.",
"TXT_CONCERN_OILREF_INFO_4"  => "Du kannst die Ölraffinerie upgraden um ihre Kapazität zu erhöhen.",
"TXT_CONCERN_OILREF_INFO_5"  => "Ölraffinerien können ein Upgrade erhalten um ihre Kapazität zu erhöhen.",
"TXT_CONCERN_OILREF_INFO_6"  => "Ölraffinerien können ein Upgrade erhalten um ihre Produktion zu erhöhen.",
"TXT_CONCERN_OILREF_INFO_7"  => "Es können neue Ölraffinerien gekauft werden.",
"TXT_CONCERN_OILREF_INFO_8"  => "Wenn genug Treibstoff verfügbar ist kann er zu den Tankstellen transportiert werden.",
"TXT_LET_TRANSPORT_FUEL"     => "Der Treibstoff wird zu den Tankstellen transportiert.",
